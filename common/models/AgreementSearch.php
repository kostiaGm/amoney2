...
class AgreementSearch extends Agreement
{
    ...
    {
        return [
            [['id', 'uid', 'periodDays',  'status'], 'integer'],
            [['name', 'text', 'amortizationDate', 'createdAt', 'updatedAt', 'deletedAt'], 'safe'],
            [['sum', 'procentOfOneDay', 'profit'], 'number'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'uid' => $this->uid,
            'sum' => $this->sum,
            'procentOfOneDay' => $this->procentOfOneDay,
            'profit' => $this->profit,
